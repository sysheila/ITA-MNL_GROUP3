    ...
    extends Service
{
    ...
    public GeoIPServiceSoap getGeoIPServiceSoap12() {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceSoap12"), GeoIPServiceSoap.class);
    }
    ...
    public GeoIPServiceSoap getGeoIPServiceSoap12(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceSoap12"), GeoIPServiceSoap.class, features);
    }
    ...
    public GeoIPServiceHttpGet getGeoIPServiceHttpGet() {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceHttpGet"), GeoIPServiceHttpGet.class);
    }
    ...
    public GeoIPServiceHttpGet getGeoIPServiceHttpGet(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceHttpGet"), GeoIPServiceHttpGet.class, features);
    }
    ...
    public GeoIPServiceHttpPost getGeoIPServiceHttpPost() {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceHttpPost"), GeoIPServiceHttpPost.class);
    }
    ...
    public GeoIPServiceHttpPost getGeoIPServiceHttpPost(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.webservicex.net/", "GeoIPServiceHttpPost"), GeoIPServiceHttpPost.class, features);
    }

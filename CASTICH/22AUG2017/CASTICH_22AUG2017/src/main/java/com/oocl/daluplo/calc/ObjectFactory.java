 ...
 * generated in the com.oocl.daluplo.calc package. 
...
public class ObjectFactory {
    ...
    private final static QName _Multiply_QNAME = new QName("http://calc.daluplo.oocl.com/", "multiply");
    private final static QName _Modulo_QNAME = new QName("http://calc.daluplo.oocl.com/", "modulo");
    private final static QName _Divide_QNAME = new QName("http://calc.daluplo.oocl.com/", "divide");
    private final static QName _DivideResponse_QNAME = new QName("http://calc.daluplo.oocl.com/", "divideResponse");
    private final static QName _ModuloResponse_QNAME = new QName("http://calc.daluplo.oocl.com/", "moduloResponse");
    private final static QName _AddResponse_QNAME = new QName("http://calc.daluplo.oocl.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://calc.daluplo.oocl.com/", "multiplyResponse");
    private final static QName _Subtract_QNAME = new QName("http://calc.daluplo.oocl.com/", "subtract");
    private final static QName _SubtractResponse_QNAME = new QName("http://calc.daluplo.oocl.com/", "subtractResponse");
    private final static QName _Add_QNAME = new QName("http://calc.daluplo.oocl.com/", "add");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oocl.daluplo.calc
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "modulo")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "divide")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "moduloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "subtract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "subtractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://calc.daluplo.oocl.com/", name = "add")

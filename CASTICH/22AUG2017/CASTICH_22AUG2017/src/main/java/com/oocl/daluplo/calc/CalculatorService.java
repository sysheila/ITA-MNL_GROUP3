 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://calc.daluplo.oocl.com/", wsdlLocation = "http://zha-ita106-w7:8080/DALUPLO_22AUG2017_CALCULATOR/CalculatorService?WSDL")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://calc.daluplo.oocl.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://zha-ita106-w7:8080/DALUPLO_22AUG2017_CALCULATOR/CalculatorService?WSDL");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://calc.daluplo.oocl.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://calc.daluplo.oocl.com/", "CalculatorPort"), Calculator.class, features);
    }

 ...
 * generated in the com.oocl.castich.sw1 package. 
...
public class ObjectFactory {
    ...
    private final static QName _SubstractResponse_QNAME = new QName("http://sw1.castich.oocl.com/", "substractResponse");
    private final static QName _AddResponse_QNAME = new QName("http://sw1.castich.oocl.com/", "addResponse");
    private final static QName _MultiplyResponse_QNAME = new QName("http://sw1.castich.oocl.com/", "multiplyResponse");
    private final static QName _Add_QNAME = new QName("http://sw1.castich.oocl.com/", "add");
    private final static QName _Multiply_QNAME = new QName("http://sw1.castich.oocl.com/", "multiply");
    private final static QName _Substract_QNAME = new QName("http://sw1.castich.oocl.com/", "substract");
    private final static QName _DivideResponse_QNAME = new QName("http://sw1.castich.oocl.com/", "divideResponse");
    private final static QName _Divide_QNAME = new QName("http://sw1.castich.oocl.com/", "divide");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oocl.castich.sw1
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "substractResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "addResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "multiplyResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "add")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "multiply")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "substract")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "divideResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://sw1.castich.oocl.com/", name = "divide")

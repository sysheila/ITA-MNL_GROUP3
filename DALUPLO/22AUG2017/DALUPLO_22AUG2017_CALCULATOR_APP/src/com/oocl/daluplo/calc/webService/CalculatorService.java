 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://sw1.castich.oocl.com/", wsdlLocation = "http://zha-ita023-w7:8080/CASTICH_22AUG2017/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://sw1.castich.oocl.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://zha-ita023-w7:8080/CASTICH_22AUG2017/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://sw1.castich.oocl.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://sw1.castich.oocl.com/", "CalculatorPort"), Calculator.class, features);
    }

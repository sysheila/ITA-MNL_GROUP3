 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://webservice.forrest.com/", wsdlLocation = "http://ZHA-ITA010-W7:8080/MyWebService/CalculatorService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://webservice.forrest.com/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://ZHA-ITA010-W7:8080/MyWebService/CalculatorService?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://webservice.forrest.com/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.forrest.com/", "CalculatorPort"), Calculator.class, features);
    }
